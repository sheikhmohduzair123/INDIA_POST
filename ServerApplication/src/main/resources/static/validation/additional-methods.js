...
(function() {
	...
	jQuery.validator.addMethod("maxWords", function(value, element, params) {
		return this.optional(element) || stripHtml(value).match(/\b\w+\b/g) <= params;
...
jQuery.validator.addMethod("nowhitespaceinstartandend", function(value, element) {
	return this.optional(element) || /^[a-zA-Z0-9]+(\s+[a-zA-Z0-9]+)*$/i.test(value);
}, "No special character allowed. No whitespace allowed in front and end.");

jQuery.validator.addMethod("pswdcheck", function(value, element) {
	return this.optional(element) || /((?=.*[a-z])(?=.*[0-9])(?=.*[@#$%])(?=.*[A-Z]).{6,15})/.test(value);
}, "Password must contain 1 upper case letter, 1 lower case letter, 1 digit, 1 special character and length must be between 6 & 15.");
...
jQuery.validator.addMethod("mobiles", function(value, element) {
	return this.optional(element) || /^[0-9][0-9]{10}$/i.test(value);
...
jQuery.validator.addMethod("decimalwithTwoPlaces", function(value, element) {
	return this.optional(element) ||  /^(?!^0*$)(?!^0*\.0*$)^\d{1,8}(\.\d{1,2})?$/i.test(value);
}, "Only numbers with two decimal places.");

jQuery.validator.addMethod("decimalwithThreePlacesIncludeZero", function(value, element) {
	return this.optional(element) ||  /^^\d{1,8}(\.\d{1,3})?$/i.test(value);
}, "Only numbers with three decimal places.");
