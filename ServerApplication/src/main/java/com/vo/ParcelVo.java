...
public class ParcelVo {
	...
	private float parcelVolumeWghtReprt;
    private float parcelDeadWghtReprt;
	...
	public float getParcelVolumeWghtReprt() {
		return parcelVolumeWghtReprt;
	}

	public void setParcelVolumeWghtReprt(float parcelVolumeWghtReprt) {
		this.parcelVolumeWghtReprt = parcelVolumeWghtReprt;
	}

	public float getParcelDeadWghtReprt() {
		return parcelDeadWghtReprt;
	}

	public void setParcelDeadWghtReprt(float parcelDeadWghtReprt) {
		this.parcelDeadWghtReprt = parcelDeadWghtReprt;
	}
