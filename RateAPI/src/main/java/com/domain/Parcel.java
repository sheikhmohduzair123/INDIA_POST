...
public class Parcel implements Serializable {
	...
	public String printShippedAddress() {
		return "Shipped from:  " + senderName + "<br>" + senderAddress.getAddressLine1() + ", "
				...
				+ ", " + senderAddress.getDivision() + ", " + senderAddress.getZone() + ", " + "Bangladesh - "
				+ senderAddress.getPostalCode() + " (Mob:0" + getSenderMobileNumber() + ")";
	}
	...
	public String printToAddress() {
		return "<b>TO: " + recipientName + "<br>" + receiverAddress.getAddressLine1() + ", "
				...
				+ "Bangladesh - " + receiverAddress.getPostalCode() + "<br>(Mob:0" + getRecipientMobileNumber() + ")";
	}
