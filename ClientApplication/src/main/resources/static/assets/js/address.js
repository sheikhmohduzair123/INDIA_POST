...
function getAddress() {
      ...
      $.ajax({
        ...
        success: function (result) {
          if (result != "") {
            ...
            $("#recieverPostalCode").css('background', 'rgb(255, 204, 203)');
            $("#errorPostal").show();
            $("#recieverZone").val('');
      ...
      $.ajax({
        ...
        success:function(result){
          ...
          $("#senderSubOffice").val(result.subOffice);
          		 ...
          		 $("#senderErrorPostal").text("Postal code does not exist");
                   $("#senderPostalCode").css('background', 'rgb(255, 204, 203)');
                   $("#senderErrorPostal").show();
                   $("#senderZone").val('');
                   $("#senderDivision").val('');
                   $("#senderDistrict").val('');
                   $("#senderThana").val('');
  ...
  $("document").ready( function() {
    $("#senderErrorPostal").hide();
      $.ajax({
    	type: "GET",
        url:"/parcel/getSenderAddress?ajax=true",
        // data:{
        //   postalCode: $("#senderPostalCode").val()
        // },
        success:function(result){
          ...
          $("#senderThana").val(result.thana);
          $("#senderSubOffice").val(result.subOffice);
            $("#senderaddress1").val(result.addressLine1);
            $("#senderaddress2").val(result.addressLine2);
            $("#senderMobileNumber").val(result.mobileNumber);
            $("#senderName").val(result.name);
        }
        	else{
          		 $("#senderErrorPostal").text("Postal code does not exist");
                   $("#senderPostalCode").css('background', 'rgb(255, 204, 203)');
