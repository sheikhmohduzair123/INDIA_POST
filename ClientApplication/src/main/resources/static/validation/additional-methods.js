...
jQuery.validator.addMethod("mobiles", function(value, element) {
	return this.optional(element) || /^[0-9][0-9]{9}$/i.test(value);
...
jQuery.validator.addMethod("Suboffice", function(value, element) {
	return this.optional(element) || /^[A-Za-z][A-Za-z0-9'\\ \\/\\.\\-\\(\\)]*$/.test(value);
}, "Special Character Not Allowed")

jQuery.validator.addMethod("parcelContentValidation", function(value, element) {
	return this.optional(element) || /^[A-Za-z0-9'\\ \\.\\/\\s\\,\\&\\-]*$/.test(value);
}, "Special Character Not Allowed")

jQuery.validator.addMethod("positiveDecimalNumber", function(value, element) {
	return this.optional(element) || /^[+]?([0-9]+(?:[\.][0-9]*)?|\.[0-9]+)$/.test(value);
}, "Only Positive Decimal Number Allowed")
jQuery.validator.addMethod("ecommerceReferenceNo", function(value, element) {
