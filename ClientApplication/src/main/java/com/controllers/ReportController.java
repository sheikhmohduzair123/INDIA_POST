...
public class ReportController {
	...
	public Map<String, List<Parcel>> dailysummarys(@RequestParam String fdate , @RequestParam String division, @RequestParam String zone, @RequestParam String district, @RequestParam String thana, @RequestParam String viewList, @RequestParam String subOffice, @RequestParam String aggregateBy) throws ParseException {
